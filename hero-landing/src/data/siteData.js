...
export const siteData = {
  ...
  services: {
    ...
    items: [
      {
        title: 'Adesivação Veicular',
        description: 'Transforme um único veículo em mídia móvel de alto impacto — ideal para carros de diretoria, representantes comerciais ou o primeiro passo antes de escalar para a frota inteira.',
        image: '/assets/gallery/veiculos/veiculo-01.webp',
        gallery: [
          '/assets/gallery/veiculos/veiculo-01.webp',
          '/assets/gallery/veiculos/veiculo-02.webp',
          '/assets/gallery/veiculos/veiculo-03.webp',
          '/assets/gallery/veiculos/veiculo-04.webp',
          '/assets/gallery/veiculos/veiculo-05.webp',
        ],
        category: 'Veículos',
        metric: 'Alcance diário equivalente a um outdoor itinerante',
        link: '#portfolio',
      },
      {
        title: 'Envelopamento de Frotas',
        description: 'Padronização visual idêntica em dezenas ou milhares de veículos, com logística de instalação coordenada em todo o Brasil — sem parar a operação da sua empresa.',
        image: '/assets/gallery/frota/frota-01.webp',
        gallery: [
          '/assets/gallery/frota/frota-01.webp',
          '/assets/gallery/frota/frota-02.webp',
          '/assets/gallery/frota/frota-03.webp',
          '/assets/gallery/frota/frota-04.webp',
          '/assets/gallery/frota/frota-05.webp',
        ],
        category: 'Frota',
      ...
      {
        title: 'Totens de Sinalização',
        description: 'Estruturas autoportantes que guiam o cliente até você — em estacionamentos, entradas e pontos de acesso. Acabamento em ACM ou acrílico, resistente a sol e chuva sem perder a cor.',
        image: '/assets/gallery/totens/totens-01.webp',
        gallery: [
          '/assets/gallery/totens/totens-01.webp',
          '/assets/gallery/totens/totens-02.webp',
          '/assets/gallery/totens/totens-03.webp',
          '/assets/gallery/totens/totens-04.webp',
          '/assets/gallery/totens/totens-05.webp',
        ],
        specs: ['ACM', 'Acrílico', 'Estrutura Galvanizada', 'Iluminado'],
        category: 'Totens',
        metric: 'Visibilidade a longa distância onde a fachada não alcança',
        link: '#portfolio',
      },
      {
        title: 'Fachadas Comerciais',
        description: 'Autoridade de marca na primeira impressão. Sinalização externa em ACM, acrílico e letra caixa iluminada que aumenta o tráfego de entrada da loja.',
        image: '/assets/gallery/fachadas/fachadas-01.webp',
        gallery: [
          '/assets/gallery/fachadas/fachadas-01.webp',
          '/assets/gallery/fachadas/fachadas-02.webp',
          '/assets/gallery/fachadas/fachadas-03.webp',
          '/assets/gallery/fachadas/fachadas-04.webp',
          '/assets/gallery/fachadas/fachadas-05.webp',
        ],
        specs: ['ACM', 'Acrílico', 'Letra Caixa', 'Vidro'],
        category: 'Fachadas',
        metric: 'Aumento no tráfego orgânico físico (footfall)',
        link: '#portfolio',
      },
      {
        title: 'Painéis e Ambientação Corporativa',
        description: 'Identidade de marca aplicada em recepções, escritórios e ambientes internos — murais e grafismo de parede que reforçam cultura e employer branding em cada metro quadrado.',
        image: '/assets/gallery/paineis/paineis-01.webp',
        gallery: [
          '/assets/gallery/paineis/paineis-01.webp',
          '/assets/gallery/paineis/paineis-02.webp',
          '/assets/gallery/paineis/paineis-03.webp',
          '/assets/gallery/paineis/paineis-04.webp',
          '/assets/gallery/paineis/paineis-05.webp',
        ],
        category: 'Painéis',
        metric: 'Fortalecimento da cultura e do employer branding',
        link: '#portfolio',
      },
      {
        ...
        gallery: [
          '/assets/gallery/banners/banner-01.webp',
          '/assets/gallery/banners/banner-02.webp',
          '/assets/gallery/banners/banner-03.webp',
          '/assets/gallery/banners/banner-04.webp',
          '/assets/gallery/banners/banner-05.webp',
        ],
